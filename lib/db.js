...
// Syarat Perancangan Project Terpadu II / Capstone Design
export const DEFAULT_DOCS = [
  ...
  { title: "9. GDRIVE MENTORA / Link & Match", sub: "*Format PDF diupload di GDRIVE pendaftaran MENTORA", icon: "fa-link", link: "https://alumni.sisfoftudinus.my.id/" }
];
...
export async function initDb() {
  ...
  // Update berkas persyaratan terbaru ke database
