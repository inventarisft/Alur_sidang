...
export const DEFAULT_CARDS = [
  ...
  { step_number: 4, shape: "decision", title: "3. UJIAN SEMINAR HASIL (SEMHAS)", description: "Penyampaian progres dan hasil riset/capstone sebelum sidang akhir.", note: "Teknik Industri (Tind): Tidak ada Seminar Hasil.", te_term: "Capstone Design 2 (Semhas)", tind_term: "- (Langsung Sidang)", tb_term: "Capstone Design 2 (Semhas)", skip_tind: true, docs_json: "[]" },
