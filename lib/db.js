...
export const DEFAULT_CARDS = [
  ...
  { step_number: 4, shape: "decision", title: "3. UJIAN SEMINAR HASIL (SEMHAS)", description: "Penyampaian progres dan naskah publikasi ilmiah sebelum mendaftar Sidang Akhir.", note: "", te_term: "Seminar Hasil (Semhas)", tind_term: "- (Langsung Sidang)", tb_term: "Seminar Hasil (Semhas)", skip_tind: true, docs_json: JSON.stringify(SEMHAS_DOCS) },
  { step_number: 5, shape: "process",  title: "4. SIDANG AKHIR", description: "Ujian pertanggungjawaban karya akhir Capstone Design 2 / Project Terpadu 2 di hadapan dewan penguji.", note: "Batas Akhir Validasi SKPI wajib tervalidasi sebelum Yudisium.", te_term: "Capstone Design 2 (Sidang Akhir)", tind_term: "Project Terpadu 2 (Sidang Akhir)", tb_term: "Capstone Design 2 (Sidang Akhir)", skip_tind: false, docs_json: JSON.stringify(DEFAULT_DOCS) },
