...
export const DEFAULT_DOCS = [
  ...
  { title: "9. Aplikasi MENTORA (KPTA)",      sub: "*Format PDF diupload di GDRIVE pendaftaran MENTORA (kpta.sisfoftudinus.my.id)", icon: "fa-link", link: "https://kpta.sisfoftudinus.my.id/" }
];
