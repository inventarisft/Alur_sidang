...
export const DEFAULT_DOCS = [
  { title: "1. Buku Bimbingan",   sub: "Diisi dari Siadin",            icon: "fa-book" },
  { title: "2. Transkrip Nilai",  sub: "Minta ke TU",                  icon: "fa-file-lines" },
  { title: "3. Bebas BIKU",       sub: "Urus di BIKU pasca bayar",     icon: "fa-receipt" },
  { title: "4. Bebas Perpus",     sub: "Urus di Perpus",               icon: "fa-graduation-cap" },
  { title: "5. KRS Aktif",        sub: "KRS Semester Ini",             icon: "fa-calendar-check" },
  { title: "6. Sertifikat TOEFL", sub: "Minimal Skor 425",             icon: "fa-certificate" },
  { title: "7. Turnitin",         sub: "Maksimal 25%",                 icon: "fa-shield-halved" },
  { title: "8. Link & Match",     sub: "alumni.sisfoftudinus.my.id",   icon: "fa-link", link: "https://alumni.sisfoftudinus.my.id/" },
];

export const DEFAULT_CARDS = [
  { step_number: 1, shape: "terminal", title: "1. TAHAP ADMINISTRASI & BERKAS PERSYARATAN", description: "Mahasiswa melengkapi berkas administrasi dan registrasi aplikasi Link & Match.", note: "Pengisian SKPI & Link-Match dapat dicicil sejak Semester 1.", te_term: "Syarat Berkas (CD)", tind_term: "Syarat Berkas (PT)", tb_term: "Syarat Berkas (CD)", skip_tind: false, docs_json: JSON.stringify(DEFAULT_DOCS) },
  { step_number: 2, shape: "process",  title: "2. UJIAN PROPOSAL", description: "Mendaftar ujian proposal dengan melampirkan berkas & Bukti Registrasi Aplikasi Link & Match.", note: "", te_term: "Capstone Design 1", tind_term: "Project Terpadu 1", tb_term: "Capstone Design 1 (Sempro)", skip_tind: false, docs_json: "[]" },
  { step_number: 3, shape: "note",     title: "UPDATE SKPI RUTIN & VERIFIKASI LINK-MATCH", description: "Memperbarui berkas SKPI secara rutin & verifikasi di Link-Match.", note: "Rutin Smt 1 - Yudisium", te_term: "Rutin Smt 1 - Yudisium", tind_term: "Rutin Smt 1 - Yudisium", tb_term: "Rutin Smt 1 - Yudisium", skip_tind: false, docs_json: "[]" },
  { step_number: 4, shape: "decision", title: "3. UJIAN SEMINAR HASIL (SEMHAS)", description: "Penyampaian progres dan hasil riset/capstone sebelum sidang akhir.", note: "", te_term: "Capstone Design 2 (Semhas)", tind_term: "- (Langsung Sidang)", tb_term: "Capstone Design 2 (Semhas)", skip_tind: true, docs_json: "[]" },
  ...
  { step_number: 6, shape: "process",  title: "5. YUDISIUM", description: "Penetapan kelulusan resmi setelah nilai sidang dan SKPI valid.", note: "Syarat SKPI & Link-Match wajib tervalidasi penuh.", te_term: "Yudisium CD", tind_term: "Yudisium PT", tb_term: "Yudisium CD", skip_tind: false, docs_json: "[]" },
...
export async function initDb() {
  ...
  // Bersihkan note step 4 jika masih berisi catatan prodi lain
